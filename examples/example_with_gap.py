"""
Example simulation with LAr gap between LC and WLS.

This script replicates the photon_sim_analytic_gap_new notebook
...
def main():
    """Run photon simulation with LAr gap configuration."""

    print("="*60)
    print("Photon Tracing Simulation - With LAr Gap")
    print("="*60)
    ...
    ax.set_title("Detector Geometry - With LAr Gap")
    plt.tight_layout()
    plt.savefig("geometry_with_gap.png", dpi=150)
    print("   Saved: geometry_with_gap.png")
    ...
    # Save results
    df.to_csv("results_with_gap.csv", index=False)
    print("   Saved: results_with_gap.csv")
    ...
    plt.savefig("statistics_with_gap.png", dpi=150)
    print("   Saved: statistics_with_gap.png")
    plt.close()

    # Path length distribution
    fig = plot_path_length_distribution(df, figsize=(10, 6))
    plt.savefig("path_lengths_with_gap.png", dpi=150)
    print("   Saved: path_lengths_with_gap.png")
    plt.close()
    ...
    plt.savefig("trajectories_arrived_with_gap.png", dpi=150)
    print("   Saved: trajectories_arrived_with_gap.png")
    plt.close()
    ...
    if lost_types:
        ...
        plt.savefig("trajectories_lost_with_gap.png", dpi=150)
        print("   Saved: trajectories_lost_with_gap.png")
        plt.close()
